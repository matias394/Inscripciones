...
@Component({
  selector: 'app-card-responsive-profesor',
  templateUrl: './card-responsive-profesor.component.html',
  styleUrls: ['./card-responsive-profesor.component.scss'],
})
export class CardResponsiveProfesorComponent {
  @Input() data: any;
  @Input() clases: any;
