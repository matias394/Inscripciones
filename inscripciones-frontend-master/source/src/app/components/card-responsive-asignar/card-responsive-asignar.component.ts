...
@Component({
  selector: 'app-card-responsive-asignar',
  templateUrl: './card-responsive-asignar.component.html',
  styleUrls: ['./card-responsive-asignar.component.scss'],
})
export class CardResponsiveAsignarComponent {
  @Input() data: any;
  @Input() clases: any;
