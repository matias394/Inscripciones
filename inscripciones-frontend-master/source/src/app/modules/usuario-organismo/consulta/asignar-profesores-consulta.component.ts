...
@Component({
  selector: 'app-asignar-profesores-consulta',
  templateUrl: './asignar-profesores-consulta.component.html',
  styleUrls: ['./asignar-profesores-consulta.component.scss'],
})
export class AsignarProfesoresConsultaComponent {
  public user: any;
  ...
  ngOnInit(): void {
    ...
    this.searchTerm$.subscribe((term) => {
      if (term !== '') {
        this.getLastInscripciones(0, 'id,desc', term);
      } else {
        this.getLastInscripciones(0, 'id,desc', '');
      }
    });
