...
export class BuscandoFormulariosComponent implements OnInit {
 ...
 // permisos = PERMISOS;
  ...
  columns: Array<any> = [
    { title: 'Nombre', name: 'nombre', sort: 'asc' },
    { title: 'Tipo de trámite asociado', name: 'nombreTipoTramite' },
    { title: 'Estado del tipo de trámite asociado', name: 'estadoTipoTramite' }
  ];
