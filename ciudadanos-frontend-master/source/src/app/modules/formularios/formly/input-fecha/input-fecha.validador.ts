...
export function InputFechaFueraDeRangoValidador(control: AbstractControl, field: FormlyFieldConfig): ValidationErrors {
  let fechaOk = true;
...
export function InputFechaPosteriorAFechaHastaValidador(control: AbstractControl, field: FormlyFieldConfig): ValidationErrors {
  let fechaOk = true;
...
export function InputFechaPosteriorAFechaActual(control: AbstractControl, field: FormlyFieldConfig): ValidationErrors {
  let fechaOk = true;
  if (control.value) {
...
export function InputFechaAnteriorAFechaDesdeValidador(control: AbstractControl, field: FormlyFieldConfig): ValidationErrors {
  let fechaOk = true;
