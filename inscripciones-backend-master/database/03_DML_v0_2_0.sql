-- DATA BASE
-- --------------------------------------------------------------------------------------------------------------
INSERT INTO INSCRIPCION.ORGANISMO(ID, NOMBRE, CREADO, CREADO_POR, MODIFICADO, MODIFICADO_POR, ESTADO)
VALUES(0, 'Sin Organismo', CURRENT_DATE, 'admin', CURRENT_DATE, 'admin', 1);



INSERT INTO INSCRIPCION.CATEGORIA(ID, NOMBRE ,NIVEL, PADRE_ID, SEQ, CREADO, CREADO_POR, MODIFICADO, MODIFICADO_POR, ESTADO)
VALUES(0, 'Sin Categoria', '0',0,'0',CURRENT_DATE, 'admin', CURRENT_DATE, 'admin', 1);



INSERT INTO INSCRIPCION.ROL(ID, NOMBRE, DESCRIPCION, CREADO, CREADO_POR, MODIFICADO, MODIFICADO_POR, ESTADO) 
...
INSERT INTO INSCRIPCION.USUARIO(ID, ORGANISMO_ID, ROL_ID, DNI, CUIL, NOMBRE, APELLIDO, EMAIL, CREADO, CREADO_POR, MODIFICADO, MODIFICADO_POR, ESTADO, PASSWORD)
VALUES(0,0,1,'123456789', '123456789', 'Usuario Admin', 'Usuario Admin', 'admin@admin.com', CURRENT_DATE, 'admin', CURRENT_DATE, 'admin', 1,'CABA.123456');

INSERT INTO INSCRIPCION.USUARIO(ID, ORGANISMO_ID, ROL_ID, DNI, CUIL, NOMBRE, APELLIDO, EMAIL, CREADO, CREADO_POR, MODIFICADO, MODIFICADO_POR, ESTADO)
VALUES(1,0,3,'100000000', '100000000', 'Sin Profesor', 'Sin Profesor', 'sinprofesor@admin.com', CURRENT_DATE, 'admin', CURRENT_DATE, 'admin', 1);



INSERT INTO INSCRIPCION.PERMISO(ID, NOMBRE, CREADO, CREADO_POR, MODIFICADO, MODIFICADO_POR, ESTADO) 
VALUES(0, 'Sin Permiso', CURRENT_DATE, 'admin', CURRENT_DATE, 'admin', 1);



INSERT INTO INSCRIPCION.ORGANISMO_CATEGORIA(ID,ORGANISMO_ID,CATEGORIA_ID,ESTADO)
VALUES(0,0,0,1);



INSERT INTO INSCRIPCION.SEDE(ID, NOMBRE, DIRECCION, PISO, EMAIL, TELEFONO, BLOQUEADO, CREADO, CREADO_POR, MODIFICADO, MODIFICADO_POR, ESTADO)
VALUES(0, 'Sin sede', 'Sin direccion', 'Piso 1', 'sinemail@gmail.com', '123456789', 1, CURRENT_DATE, 'admin', CURRENT_DATE, 'admin', 1);



INSERT INTO INSCRIPCION.NOTIFICACION(ID, NOMBRE, DESCRIPCION, CREADO, CREADO_POR, MODIFICADO, MODIFICADO_POR, ESTADO)
...
INSERT INTO INSCRIPCION.MODALIDAD(ID, NOMBRE, DESCRIPCION, CREADO, CREADO_POR, MODIFICADO, MODIFICADO_POR, ESTADO)
...
INSERT INTO INSCRIPCION.ESTADO(ID, NOMBRE, DESCRIPCION, CREADO, CREADO_POR, MODIFICADO, MODIFICADO_POR, ESTADO)
VALUES(0, 'Sin Estado', 'Sin descripcion estado', CURRENT_DATE, 'admin', CURRENT_DATE, 'admin', 1);


INSERT INTO INSCRIPCION.CORREO(ID, NOMBRE, ASUNTO, DESCRIPCION, HTML, CREADO, CREADO_POR, MODIFICADO, MODIFICADO_POR, ESTADO)
VALUES(0, 'Sin Correo', 'Sin Asunto', 'Sin Descripcion', 'Sin html',CURRENT_DATE, 'admin', CURRENT_DATE, 'admin', 1);

INSERT INTO INSCRIPCION.CORREO (ID, NOMBRE, ASUNTO, DESCRIPCION, HTML, CREADO, CREADO_POR, MODIFICADO, MODIFICADO_POR, ESTADO)
VALUES (1,'Correo Principal', 'Correo Principal', 'Correo Principal',
        EMPTY_CLOB() || '<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
...
INSERT INTO INSCRIPCION.TIPO(ID, NOMBRE, DESCRIPCION, CREADO, CREADO_POR, MODIFICADO, MODIFICADO_POR, ESTADO)
